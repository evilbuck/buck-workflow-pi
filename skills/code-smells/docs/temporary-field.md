...
- Temporary fields and all code operating on them can be put in a separate class via [Extract Class](/refactoring/extract-class). In other words, you're creating a method object, achieving the same result as if you would perform [Replace Method with Method Object](/refactoring/replace-method-with-method-object).
- [Introduce Null Object](/refactoring/introduce-null-object) and integrate it in place of the conditional code which was used to check the temporary field values for existence.

...
- Components that are near-useless should be given the [Inline Class](/refactoring/inline-class) treatment.

- For subclasses with few functions, try [Collapse Hierarchy](/refactoring/collapse-hierarchy).

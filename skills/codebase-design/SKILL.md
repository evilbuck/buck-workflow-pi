...
description: >
  ...
  skill needs the deep-module vocabulary. Model-invoked reference — load by
  skill name (e.g. /skill:codebase-design); no slash-command prompt wrapper
  (precedent: fix-pr).
---
...
> Origin: ported from `mattpocock/skills` (`skills/engineering/codebase-design/`,

---
name: b-review
description: Review implementation changes for correctness, edge cases, regressions, and workflow compliance. Use after b-build, b-build-hard, or b-iterate to validate work before committing.
---

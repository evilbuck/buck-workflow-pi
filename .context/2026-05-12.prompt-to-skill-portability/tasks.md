...
- [x] Inventory prompt templates and classify each as canonical skill, thin wrapper, runtime automation, or helper.
- [x] Create canonical skills for prompt-only Buck workflows.
- [x] Convert Pi prompt templates into thin wrappers around canonical skills.
- [x] Resolve duplication between `prompts/b-present.md` and `skills/b-present/SKILL.md`.

...
- [ ] Phase 2: TypeSafe Model Picker — build-hard → review → iterate/docs if needed → save → commit
- [ ] Phase 3: Loop Runtime Cutover — build-hard → review → iterate/docs if needed → save → commit

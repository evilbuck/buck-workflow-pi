...
- [ ] [Phase 2: Kernel contract doc](items/phase-2-kernel-contract-doc.md) — depends on Phase 1
- [ ] [Phase 3: Real kernel usage examples](items/phase-3-eval-kernel-examples.md) — depends on Phase 2

...
| 7: Safety proof, docs, and smoke | completed | medium | none | [phase-7-proof-docs-smoke.md](phase-7-proof-docs-smoke.md) |
...
- [x] Phase 7: Safety proof, docs, and smoke — build → review → iterate if in-plan issues → docs if doc impact → save → commit

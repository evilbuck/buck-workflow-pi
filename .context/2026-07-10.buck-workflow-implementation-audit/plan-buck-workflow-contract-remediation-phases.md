...
| 2: Save-owned closeout transaction | completed | hard | none | [phase-2-save-owned-closeout.md](phase-2-save-owned-closeout.md) |
...
- [x] Phase 2: Save-owned closeout transaction — build → review → iterate if needed → docs if needed → save → stage → commit
